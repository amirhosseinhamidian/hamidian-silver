...
export const DEFAULT_CONTENT: Record<StorefrontContentPageKey, PublicContentPageDto> = {
  [StorefrontContentPageKey.ABOUT]: {
    ...
    body: 'گالری حمیدیان با تمرکز بر انتخاب دقیق، اصالت محصول و همراهی صادقانه شکل گرفته است. هر قطعه برای ما بخشی از یک روایت شخصی است؛ روایتی که باید سال‌ها درخشان بماند.',
    heroMedia: null,
    ...
    seoTitle: 'درباره گالری حمیدیان',
    seoDescription: 'با داستان، ارزش‌ها و نگاه گالری حمیدیان آشنا شوید.',
  ...
  [StorefrontContentPageKey.CONTACT]: {
    ...
    heroMobileMedia: null,
    sections: [],
    seoTitle: 'تماس با گالری حمیدیان',
    seoDescription: 'راه‌های ارتباط با گالری حمیدیان و دریافت مشاوره.',
    seoCanonicalPath: null,
    seoNoIndex: false,
    seoOgMedia: null,
  },
  [StorefrontContentPageKey.SERVICES]: {
    ...
    seoTitle: 'خدمات گالری حمیدیان',
    seoDescription: 'آشنایی با خدمات مشاوره، نگهداری و پشتیبانی گالری حمیدیان.',
    seoCanonicalPath: null,
    seoNoIndex: false,
    seoOgMedia: null,
  },
  [StorefrontContentPageKey.TERMS]: {
    ...
    subtitle: 'چارچوب استفاده از فروشگاه و ثبت سفارش در گالری حمیدیان.',
    ...
    heroMobileMedia: null,
    sections: [],
    seoTitle: 'شرایط و قوانین گالری حمیدیان',
    seoDescription: 'شرایط استفاده، ثبت سفارش و خرید از فروشگاه گالری حمیدیان.',
    seoCanonicalPath: null,
    seoNoIndex: false,
    seoOgMedia: null,
  },
  [StorefrontContentPageKey.PRIVACY]: {
    ...
    body: 'اطلاعات کاربران تنها برای ارائه خدمات فروشگاه، پردازش سفارش و ارتباط ضروری استفاده می‌شود. دسترسی به این اطلاعات محدود و متناسب با نیاز عملیاتی است.\n\nگالری حمیدیان اطلاعات شخصی کاربران را خارج از الزامات قانونی و ارائه خدمات در اختیار اشخاص غیرمرتبط قرار نمی‌دهد.',
    heroMedia: null,
    heroMobileMedia: null,
    sections: [],
    seoTitle: 'حریم خصوصی گالری حمیدیان',
    seoDescription: 'سیاست حفظ حریم خصوصی و نحوه استفاده از اطلاعات کاربران گالری حمیدیان.',
    seoCanonicalPath: null,
    seoNoIndex: false,
    seoOgMedia: null,
  },
  [StorefrontContentPageKey.SIZE_GUIDE]: {
    ...
    seoDescription:
      'راهنمای اندازه‌گیری سایز انگشتر، دستبند و گردنبند برای خرید مطمئن از گالری حمیدیان.',
    seoCanonicalPath: null,
    seoNoIndex: false,
    seoOgMedia: null,
  },
