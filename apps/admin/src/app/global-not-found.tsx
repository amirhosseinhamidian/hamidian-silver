...
export const metadata: Metadata = {
  title: 'صفحه پیدا نشد | پنل مدیریت نقره حمیدیان',
    ...
    <html lang="fa" dir="rtl" className={vazirmatn.variable}>
      <body>
        <main className="grid min-h-dvh place-items-center bg-[var(--admin-color-canvas)] px-4 py-8">
          <section
            aria-labelledby="admin-global-not-found-title"
          ...
          >
            ...
            <h1 id="admin-global-not-found-title" className="mt-3 text-2xl font-bold">
              این صفحه در پنل مدیریت پیدا نشد
            </h1>
            <p className="mt-3 text-sm leading-7 text-[var(--admin-color-muted)]">
              نشانی واردشده اشتباه است یا این صفحه دیگر وجود ندارد.
            </p>
